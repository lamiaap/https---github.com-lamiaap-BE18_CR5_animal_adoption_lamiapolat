        ...
        <form method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><button name="submit" class="btn btn-primary" type="submit">Save Changes</button></td>
                    <td><a href="<?php echo $backBtn ?>"><button class="btn btn-danger" type="button">Back</button></a></td>
                </tr>
            </table>
        </form>
    </div>
